# This Makefile is for the WWW::GooglePlay::Scraper extension to perl.
#
...
#     ABSTRACT => q[Get software rank/review/rate on Google Play.]
#     AUTHOR => [q[KAWABATA, Kazumichi (Higemaru) <kawabata@cpan.org>]]
#     BUILD_REQUIRES => { Test::Base=>q[0], ExtUtils::MakeMaker=>q[6.59] }
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[WWW-GooglePlay-Scraper]
#     LICENSE => q[perl]
#     MIN_PERL_VERSION => q[5.008]
#     NAME => q[WWW::GooglePlay::Scraper]
#     NO_META => q[1]
#     PREREQ_PM => { Test::Base=>q[0], LWP::UserAgent=>q[0], ExtUtils::MakeMaker=>q[6.59], Web::Scraper=>q[0] }
#     VERSION => q[0.10]
#     VERSION_FROM => q[lib/WWW/GooglePlay/Scraper.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = WWW::GooglePlay::Scraper
NAME_SYM = WWW_GooglePlay_Scraper
VERSION = 0.10
...
MAKEMAKER   = /Users/oneroad/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.62
MM_REVISION = 66200
...
MAKE = make
FULLEXT = WWW/GooglePlay/Scraper
BASEEXT = Scraper
PARENT_NAME = WWW::GooglePlay
DLBASE = $(BASEEXT)
VERSION_FROM = lib/WWW/GooglePlay/Scraper.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/WWW/GooglePlay/Scraper.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/WWW/GooglePlay
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/WWW/GooglePlay
...
TO_INST_PM = lib/WWW/GooglePlay/Scraper.pm

PM_TO_BLIB = lib/WWW/GooglePlay/Scraper.pm \
	blib/lib/WWW/GooglePlay/Scraper.pm
...
DISTNAME = WWW-GooglePlay-Scraper
DISTVNAME = WWW-GooglePlay-Scraper-0.10
...
manifypods : pure_all  \
	lib/WWW/GooglePlay/Scraper.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/WWW/GooglePlay/Scraper.pm $(INST_MAN3DIR)/WWW::GooglePlay::Scraper.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Get software rank/review/rate on Google Play.</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>KAWABATA, Kazumichi (Higemaru) &lt;kawabata@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/WWW/GooglePlay/Scraper.pm blib/lib/WWW/GooglePlay/Scraper.pm 
